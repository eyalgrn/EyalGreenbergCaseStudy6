...
##### Second step: We will run the summary function, and count the NAs in two places-
###### 1. Column "Ranking" (originally in the GDP file)
###### 2. Column "Long.Name" (originally in the EDUC file)

##### Third step: We will deduct the total NAs in these two columns from the total numbers of rows. The remaining is the value we are looking for - the values that matched between the two files. 

##### The total matched data is 235-45-1=189
```{r}
dim(MergedData)
summary(MergedData)
```
